...
code = code.replace(/function nextTrack\(\) \{[\s\S]*?(?=function playMacroItem\(\)|function nextPlaylist\(\)|const _getElementById)/m, replacement + "\n\n  ");

fs.writeFileSync('index.html', code);
console.log("Patched nextTrack and prevTrack");
